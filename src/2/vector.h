...
/// @param arg3
/// @param d
static inline void gf2_vector_add_scalar_u256_v2(gf2 *out,
                                                 const gf2 *in1,
                                                 const gf2 scalar,
                                                 const gf2 *in2,
                                                 const uint32_t d) {
...
/// @param scalar
/// @param d
static inline void gf2_vector_scalar_add_u256_v3(gf2 *out,
                                                 const gf2 *in1,
                                                 const gf2 scalar,
                                                 const uint32_t d) {
    uint32_t nbytes = (d + 7)/8;
...
/// \return in1(scalar)
static inline gf2 mirath_vec_ff_eval_arith(const gf2 *in1,
                                           const gf2 scalar, 
                                           const uint32_t d) {
    uint32_t nbytes = (d + 7)/8;
    const uint8_t m = -scalar;
